...
describe('(mounted) Calculator', () => {
  ...
  it('calls updateDisplay when a number key is clcked', () => {
  ...
  it('calls setOperator when an operator key is clcked', () => {
  ...
  it('calls callOperator when an operator key is clcked', () => {
...
describe('callOperator', () => {
  ...
  it('updates displayValue to the sum of decimal values', () => {
    wrapper.setState({ storedValue: '2.5' });
    wrapper.setState({ displayValue: '4.6' });
    wrapper.setState({ selectedOperator: '+' });
    wrapper.instance().callOperator();
    expect(wrapper.state('displayValue')).toEqual('7.1');
  });
